...
func (a *AlertAPI) Ack(alertID int, payload *AlertAckRequest) (*BaseResponse, error) {
	c := a.client
...
func (a *AlertAPI) Get(alertID int) (*AlertsResponse, error) {
	c := a.client
...
//
// Documentation: https://docs.librenms.org/API/Alerts/#list_alerts
func (a *AlertAPI) List(query *AlertsQuery) (*AlertsResponse, error) {
	c := a.client
	if query == nil {
