...
func TestClient_GetLocation(t *testing.T) {
	...
	locationResp, err := testAPIClient.Location.Get(testLocationID)
...
func TestClient_GetLocations(t *testing.T) {
	...
	locationResp, err := testAPIClient.Location.List()
...
func TestClient_CreateLocation(t *testing.T) {
	...
	createResp, err := testAPIClient.Location.Create(&newLocationRequest)
...
func TestClient_DeleteLocation(t *testing.T) {
	...
	resp, err := testAPIClient.Location.Delete(testLocationID)
