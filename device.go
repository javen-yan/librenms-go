...
func (d *DeviceAPI) Create(payload *DeviceCreateRequest) (*DeviceResponse, error) {
	c := d.client
...
func (d *DeviceAPI) Delete(identifier string) (*DeviceResponse, error) {
	c := d.client
...
func (d *DeviceAPI) Get(identifier string) (*DeviceResponse, error) {
	c := d.client
...
func (d *DeviceAPI) List(query *DevicesQuery) (*DeviceResponse, error) {
	c := d.client
...
func (d *DeviceAPI) Update(identifier string, payload *DeviceUpdateRequest) (*BaseResponse, error) {
	c := d.client
