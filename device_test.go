...
func TestClient_GetDevice(t *testing.T) {
	...
	deviceResp, err := testAPIClient.Device.Get("1.1.1.1")
...
func TestClient_GetDevices(t *testing.T) {
	...
	deviceResp, err := testAPIClient.Device.List(nil)
...
func TestClient_CreateDevice(t *testing.T) {
	...
	createResp, err := testAPIClient.Device.Create(&newDeviceRequest)
...
func TestClient_DeleteDevice(t *testing.T) {
	...
	deviceResp, err := testAPIClient.Device.Delete("1.1.1.1")
...
func TestClient_UpdateDevice(t *testing.T) {
	...
	deviceResp, err := testAPIClient.Device.Update("1.1.1.1", payload)
