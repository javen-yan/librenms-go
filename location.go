...
func (l *LocationAPI) Create(location *LocationCreateRequest) (*BaseResponse, error) {
	c := l.client
...
func (l *LocationAPI) Delete(locationID int) (*BaseResponse, error) {
	c := l.client
...
func (l *LocationAPI) Get(locationID int) (*LocationResponse, error) {
	c := l.client
...
func (l *LocationAPI) List() (*LocationsResponse, error) {
	c := l.client
...
func (l *LocationAPI) Update(locationID int, location *LocationUpdateRequest) (*BaseResponse, error) {
	c := l.client
