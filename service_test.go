...
func TestClient_GetService(t *testing.T) {
	...
	serviceResp, err := testAPIClient.Service.Get(testServiceID)
...
func TestClient_GetServices(t *testing.T) {
	...
	serviceResp, err := testAPIClient.Service.List()
...
func TestClient_GetServicesForHost(t *testing.T) {
	...
	serviceResp, err := testAPIClient.Service.GetForHost(testServiceDeviceID)
...
func TestClient_CreateService(t *testing.T) {
	...
	createResp, err := testAPIClient.Service.Create(testServiceDeviceID, &newServiceRequest)
...
func TestClient_DeleteService(t *testing.T) {
	...
	resp, err := testAPIClient.Service.Delete(testServiceID)
