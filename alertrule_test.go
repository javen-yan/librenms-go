...
func TestClient_GetAlertRule(t *testing.T) {
	...
	resp, err := testAPIClient.AlertRule.Get(testAlertRuleID)
...
func TestClient_GetAlertRules(t *testing.T) {
	...
	resp, err := testAPIClient.AlertRule.List()
...
func TestClient_CreateAlertRule(t *testing.T) {
	...
	createResp, err := testAPIClient.AlertRule.Create(&newAlertRuleRequest)
...
func TestClient_DeleteAlertRule(t *testing.T) {
	...
	resp, err := testAPIClient.AlertRule.Delete(testAlertRuleID)
...
func TestClient_UpdateAlertRule(t *testing.T) {
	...
	resp, err := testAPIClient.AlertRule.Update(&payload)
...
func TestClient_UpdateAlertRule_MissingID(t *testing.T) {
	...
	_, err := testAPIClient.AlertRule.Update(&payload)
