...
func (s *ServiceAPI) Create(deviceIdentifier string, service *ServiceCreateRequest) (*ServiceResponse, error) {
	c := s.client
...
func (s *ServiceAPI) Delete(serviceID int) (*BaseResponse, error) {
	c := s.client
...
func (s *ServiceAPI) Get(serviceID int) (*ServiceResponse, error) {
	c := s.client
...
func (s *ServiceAPI) List() (*ServiceResponse, error) {
	c := s.client
	req, err := c.newRequest(http.MethodGet, serviceEndpoint, nil, nil)
	if err != nil {
		return nil, err
...
func (s *ServiceAPI) GetForHost(deviceIdentifier string) (*ServiceResponse, error) {
	c := s.client
...
func (s *ServiceAPI) Update(serviceID int, service *ServiceUpdateRequest) (*ServiceResponse, error) {
	c := s.client
